...
const Home = () => {
    return <Box>
        ...
        <Container w={"container.xl"} minH={"100vh"} p="16" >
            ...
            <Stack h="full" p={"4"} alignItems={'center'} justifyContent={"center"} direction={['column', 'row']}
            >
                <Image src={img5} h={["40", "400"]} filter={"hue-rotate(-130deg)"} />

                <Text letterSpacing={"wider"} lineHeight={"190%"} p={["4", "16"]} textAlign="center" >
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta, rerum at quasi tenetur reprehenderit labore! Lorem ipsum dolor sit amet.
                </Text>
            </Stack>
