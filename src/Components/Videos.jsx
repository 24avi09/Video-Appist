...
import {  Stack, VStack, Heading,  Button, Text } from "@chakra-ui/react"
        ...
        <Stack direction={['column', 'row']} h={"100vh"} >
            <VStack w={'full'} >
                ...
                <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'} >
                    ...
                    <Text>
                        This is a sample video for tecting and demo. This is called discription. <br /> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam provident fuga consectetur, quam molestiae nobis rerum porro amet cum placeat libero tempore fugit nemo labore sapiente! Dolorum blanditiis nesciunt et ullam distinctio eos vel cumque vitae. Repudiandae quas dolores esse necessitatibus beatae delectus qui doloribus ipsam impedit enim sit, illo veniam hic cumque aperiam incidunt repellat illum quod iure aspernatur, neque adipisci corrupti pariatur officiis. Sunt fuga facere quasi, et eum corporis ipsum error at quae deserunt animi suscipit perspiciatis quam repellendus, recusandae enim nihil. Nulla praesentium aperiam modi quasi! Officiis modi iure tempore eos? Ipsa deserunt temporibus quam quo molestiae excepturi iure recusandae modi eum maxime et sapiente necessitatibus quidem, voluptatem expedita, reiciendis beatae corrupti sequi fuga saepe minus autem eos. Explicabo reiciendis eum ut! Alias quae sunt quam eaque omnis, fugiat architecto. Dolorem ducimus ullam amet. Dolorem fugit doloribus harum recusandae quos. Accusantium, reiciendis laborum! Eveniet, fuga error.
                    </Text>
                </VStack>
            </VStack>
